        ...
        <>
            ...
            >
                ...
                <div ref={contactRef} className="text-center pt-16">
                    ...
                    {/* Social Media Grid */}
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-2xl mx-auto mb-12">
                        {/* LinkedIn */}
                        <a 
                        ...
                        >
                            ...
                            <span className="text-sm font-medium text-pink-400 group-hover:text-pink-300">Instagram</span>
                        </a>

                        {/* Email */}
                        <button
                            onClick={handleCopyEmail}
                            className="contact-button group flex flex-col items-center p-6 bg-gray-900/30 border border-gray-700/50 rounded-xl cursor-pointer hover:border-cyan-400/50 hover:bg-cyan-900/20 transition-all duration-300 opacity-0 relative"
                        >
